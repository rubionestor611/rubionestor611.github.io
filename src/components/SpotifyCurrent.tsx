import { CurrentTrack, SpotifyProfile } from "../utils/types";
...
const SpotifyCurrent = ({profile, current}:Props) => {
            ...
            <div className="flex-1 sm:min-w-[300px]">
                {
                    ...
                    <div className="flex-1 h-full flex flex-col justify-center items-center gap-2">
                        <p className="flex-1 text-[20px] font-bold text-darkText">Currently Playing</p>
                        <p className="flex-1 text-center text-sm text-darkText">{current}</p>
                    </div>
                }
            </div>
        </div>
